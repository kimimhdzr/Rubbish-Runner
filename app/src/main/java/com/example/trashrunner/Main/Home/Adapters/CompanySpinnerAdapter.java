...
public class CompanySpinnerAdapter extends ArrayAdapter<CompanyBasicModel> {
    private final List<CompanyBasicModel> companies;

    public CompanySpinnerAdapter(@NonNull Context context, @NonNull List<CompanyBasicModel> companies) {
